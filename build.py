...
<meta name="naver-site-verification" content="f45cf438ac4d2be80641878791408b55a00e5a6c" />
  ...
  <div class="container header-inner">
    ...
    <nav class="gnb" aria-label="주 메뉴" id="gnb">
      ...
      <div class="mobile-only-cta">
        <a class="btn btn--primary btn--block" href="tel:0508-4260-3312">☎ 0508-4260-3312 전화상담</a>
        <!-- 광고문의 비활성화
    ...
    <div class="header-actions">
      <a class="header-phone" href="tel:0508-4260-3312">
        <small>🚨 24시 긴급출동 · 연중무휴</small>
        <strong>0508-4260-3312</strong>
      </a>
      <!-- 광고문의 비활성화
...
FOOTER = """<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-keywords">
      <h4>취급 서비스</h4>
      <p class="fk-list">누수탐지 · 누수공사 · 하수구막힘 · 배관막힘 · 배관설비 · 수전교체 · 싱크대수전교체 · 화장실수전교체 · 변기막힘 · 화장실변기교체 · 변기부속품수리 · 싱크대하수구막힘 · 세면대막힘 · 세면대교체 · 배수구막힘 · 배수구뚫음 · 욕실배관누수 · 수도누수 · 수도수리 · 주방배관누수 · 주방배수구막힘</p>
      <p class="fk-sub">배관 이물질 제거, 내시경(CCTV) 검사, 역류·물샘·누수 잡기, 노후 부품 교체, 배관 공사·수리·고압세척까지 — 합리적인 비용·가격으로 안내하는 전문 업체입니다.</p>
    </div>
    ...
    <address class="footer-biz">
      ...
      <div>주소: (미정)</div>
      <div>대표전화: <a href="tel:0508-4260-3312">0508-4260-3312</a> · 카카오톡 상담: @스피드배관</div>
...
def page(path, title, desc, canonical, body, jsonld="", og_title=None, og_desc=None, noindex=False):
    ...
    # 광고문의 팝업(AD_POPUP) 비활성화 — 필요 시 아래 + AD_POPUP 주석 해제
...
def bottom_cta(h2="상업시설 배관, 지금 바로 출동합니다",
  ...
  <div class="container">
    <div class="cta-banner"><div class="cta-banner-inner">
      ...
      <div class="hero-cta">
        <a class="btn btn--primary btn--lg" href="tel:0508-4260-3312">☎ 0508-4260-3312</a>
        <!-- 광고문의 비활성화
